...
This repository contains the package with internationalization.
...
In order to install and use the linked dependencies for `pkg-i18n` the following command can be used:
